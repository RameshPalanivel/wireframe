(function($)
{
	...
	$(document).ready(function()
	{
	    ...
	    $('#settingsmenu').removeClass('ui-menu ui-widget ui-widget-content ui-corner-all').removeAttr("role").removeAttr("aria-activedescendant");
	    $('li').removeClass('ui-menu-item').removeAttr("role");
	});
