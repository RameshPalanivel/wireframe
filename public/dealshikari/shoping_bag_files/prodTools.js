...
var isFirst = true;
var isNoImage = false;
function ShowImageTooltip(imagePath, imageName) {
    var html;
...
function ShowSwatchImageTooltip(imagePath, imageName) {
    var html;

    html = '<div id="productSwatch" class="productSwatch">';
    html += '<img src=' + imagePath + ' border="0"/>';
    html += '</div>';
